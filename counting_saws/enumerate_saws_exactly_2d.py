...
def enumerate_walks(n, current_position, visited_positions, counts, current_length):
    ...
    directions = [(1, 0), (-1, 0), (0, 1), (0, -1)]  # 2D grid movements
...
def compute_saws(N_max):
    ...
    for n in range(start_n, N_max + 1):
        ...
        enumerate_walks(1, (0, 0), visited_positions, counts, n)
...
if __name__ == "__main__":
    N_max = 17  # Set this value for the desired maximum length of SAWs
